 ...
 * @subpackage Awesome_Assesment/includes
 * @author     Justin Vogt <mail@juvo-design.de>
 */
class Awesome_Assesment
{

    const PLUGIN_NAME = 'awesome-assesment';
    ...
    private function load_dependencies(): void
    {
        ...
        $this->awesomecpt = new cpt\AA_Awesome_Post_Type();
    ...
    private function define_public_hooks(): void
    {
        ...
        add_action('wp_enqueue_scripts', function () {
            ...
            $this->loader->add_action('init',$this->awesomecpt,'register');
//        add_action('init',$this->awesomecpt->register());
    ...
    {
        $entrypoints_manifest = AWESOME_ASSESMENT_PATH . '/dist/entrypoints.json';
                ...
                foreach ($files as $file) {
                    if ($type == "js") {
                        wp_enqueue_script(
                            ...
                            AWESOME_ASSESMENT_URL . 'dist/' . $file,
                            $bundle->dependencies ?? [],
                            null,
                            true,
                        );
