...
namespace Awesome_Assesment\Cli;
...
class Setup {
	...
	public function __invoke( array $args, array $assoc_args ): void {
		...
		// Replace in files
		if (
			! $this->replaceInFiles( 'awesome-assesment', $this->slug, [ '.*\.php', '.*\.js', '.*\.json' ] )
			|| ! $this->replaceInFiles( 'awesome_assesment', str_replace( '-', '_', $this->slug ), [ '.*\.php' ] )
			|| ! $this->replaceInFiles( 'Awesome_Assesment', $this->namespace, [ '.*\.php', '.*\.json' ] )
			|| ! $this->replaceInFiles( 'AWESOME_ASSESMENT', strtoupper( $this->namespace ), [ '.*\.php', '.*\.json' ] )
			|| ! $this->replaceInFiles( 'Awesome Assesment', $this->name, [ '.*\.php', '.*README\.txt' ] )
		) {
	...
	private function rename_files(): void {
		if (
			! rename( $this->path . '/src/Awesome_Assesment.php', $this->path . "/src/$this->namespace.php" )
			|| ! rename( $this->path . '/awesome-assesment.php', $this->path . "/$this->slug.php" )
		) {
